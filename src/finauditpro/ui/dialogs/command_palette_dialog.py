...
class CommandPaletteDialog(QDialog):
    ...
    def _register_default_commands(self) -> None:
        self._all_commands = [
            ...
            {
                "title": "Planning & SA 320 Materiality",
                "category": "Pipeline",
                "shortcut": "Alt+3",
                "key": "nav",
                "payload": 2,
            ...
            {
                "title": "Schedule III Working Papers",
                "category": "Pipeline",
                "shortcut": "Alt+5",
                "key": "nav",
                "payload": 4,
            ...
            {
                "title": "Statutory Audit Reports & Sign-Off",
                "category": "Pipeline",
                "shortcut": "Alt+6",
                "key": "nav",
                "payload": 5,
            ...
            {
                "title": "Uploaded Evidence & Document Vault",
                "category": "Fieldwork",
                "shortcut": "",
                "key": "nav",
                "payload": 7,
            ...
            {
                "title": "Audit Firm Configuration",
                "category": "Admin",
                "shortcut": "",
                "key": "nav",
                "payload": 13,
            ...
            {
                "title": "Archival & Cryptographic Sealing",
                "category": "System",
                "shortcut": "",
                "key": "nav",
                "payload": 14,
