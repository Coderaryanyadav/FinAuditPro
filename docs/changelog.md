...
### Added
- GitHub CI/CD pipeline (`.github/workflows/ci.yml`) supporting Python 3.12 and 3.14.
- Security scanner workflow (`.github/workflows/security.yml`) integrating Bandit analysis.
- Comprehensive technical documentation suite in `docs/` (`architecture.md`, `security.md`, `ai.md`, `database.md`, `document-processing.md`, `testing.md`).
- Architectural Review Report (`ARCHITECTURE_REVIEW.md`).
