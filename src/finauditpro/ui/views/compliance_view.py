...
CARO_2020_CLAUSES = [
    (
        "Clause (i)",
        "Fixed Assets & PPE",
        "Maintenance of proper records of Property, Plant & Equipment and physical verification",
    ),
    (
        "Clause (ii)",
    ...
    (
        "Clause (iv)",
        "Sec 185/186 Statutory Compliance",
        "Compliance with provisions of Section 185 and 186 in respect of loans & guarantees",
    ),
    (
        "Clause (v)",
    ...
    (
        ...
        "Default in repayment of loans/borrowings to banks, financial institutions or lenders",
    ),
    (
        "Clause (x)",
        "IPO / FPO / Preferred Funds",
...
FORM_3CD_CLAUSES = [
    ...
    (
        "Clause 44",
        "GST Expenditure Split",
        "Break-down of total expenditure into GST registered vs exempt vs non-registered entities",
    ),
]
...
class ComplianceView(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        tabs.setStyleSheet("""
            ...
            QTabBar::tab { font-size: 12px; font-weight: 600; padding: 8px 18px; color: #64748B; border: none; background: transparent; }
            QTabBar::tab:selected { color: #2563EB; border-bottom: 2px solid #2563EB; font-weight: 700; }
        """)
