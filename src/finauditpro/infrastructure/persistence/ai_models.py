...
class AIProviderConfigModel(Base):
    ...
    base_url: Mapped[str] = mapped_column(String(255), nullable=False, default="http://localhost:1234/v1")
    chat_model_id: Mapped[str] = mapped_column(String(255), nullable=False, default="deepseek/deepseek-r1-distill-qwen-14b")
    embedding_model_id: Mapped[str] = mapped_column(String(255), nullable=False, default="text-embedding-nomic-embed-text-v1.5")
