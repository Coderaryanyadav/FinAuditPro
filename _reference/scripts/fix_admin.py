...
Usage:
    .venv/bin/python scripts/fix_admin.py --password <NewPassword>
    python3 scripts/fix_admin.py --password <NewPassword>
    python3 scripts/fix_admin.py --email admin@finauditpro.com --password <NewPassword>
    python3 scripts/fix_admin.py --unlock
"""
...
# Auto-locate project root & re-execute with .venv python if available
