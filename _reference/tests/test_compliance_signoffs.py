...
def test_compliance_signoffs_roundtrip():
    ...
    with patch("PySide6.QtWidgets.QMessageBox.information"):
        ...
        caro_combo.setCurrentText("⚠ Review Required")

        f3cd_combo = widget.f3cd_table.cellWidget(0, 3)
        assert isinstance(f3cd_combo, QComboBox)
        f3cd_combo.setCurrentText("✕ Disallowance Applicable")
        ...
        assert data.get("caro", {}).get(code_caro) == "⚠ Review Required"
        assert data.get("form3cd", {}).get(code_f3cd) == "✕ Disallowance Applicable"
        ...
        assert caro_combo2.currentText() == "⚠ Review Required"

        f3cd_combo2 = widget2.f3cd_table.cellWidget(0, 3)
        assert f3cd_combo2.currentText() == "✕ Disallowance Applicable"
