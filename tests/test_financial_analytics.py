...
def test_duplicate_transaction_detection() -> None:
    records = [
        {"row_index": 1, "date": "2026-04-10", "amount": 150000.0, "account_name": "Consulting Fees", "transaction_id": "TXN101"},
        {"row_index": 2, "date": "2026-04-10", "amount": 150000.0, "account_name": "Consulting Fees", "transaction_id": "TXN102"},
        {"row_index": 3, "date": "2026-04-11", "amount": 200000.0, "account_name": "Rent", "transaction_id": "TXN103"},
    ]
...
def test_high_value_transaction_anomaly() -> None:
    records = [
        {"row_index": 1, "date": "2026-04-10", "amount": 250000.0, "account_name": "Office Supplies"},
        {"row_index": 2, "date": "2026-04-12", "amount": 750000.0, "account_name": "Plant & Machinery"},
    ]
...
def test_weekend_posting_anomaly() -> None:
    records = [
        {"row_index": 1, "date": "2026-04-10", "amount": 50000.0, "account_name": "Friday Payment"},   # Friday
        {"row_index": 2, "date": "2026-04-11", "amount": 50000.0, "account_name": "Saturday Payment"}, # Saturday
        {"row_index": 3, "date": "2026-04-12", "amount": 50000.0, "account_name": "Sunday Payment"},   # Sunday
    ]
...
def test_sequence_gap_detection() -> None:
    records = [
        {"row_index": 1, "transaction_id": "INV-1001", "invoice_number": "INV-1001", "amount": 100.0},
        {"row_index": 2, "transaction_id": "INV-1002", "invoice_number": "INV-1002", "amount": 200.0},
        {"row_index": 3, "transaction_id": "INV-1005", "invoice_number": "INV-1005", "amount": 500.0},
    ]
